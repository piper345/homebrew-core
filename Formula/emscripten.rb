...
class Emscripten < Formula
  ...
  url "https://github.com/emscripten-core/emscripten/archive/3.1.9.tar.gz"
  sha256 "b07bf8328eac2ac59957dac27fc8e91f5ac4d3f39354710b798f7e552c33d430"
  license all_of: [
    "Apache-2.0", # binaryen
  ...
  resource "binaryen" do
    url "https://github.com/WebAssembly/binaryen.git",
        revision: "68807a4f8570a58f9e5d3756f54476884b97a366"
  end
  ...
  resource "llvm" do
    url "https://github.com/llvm/llvm-project.git",
        revision: "faef447e72a5c63dfb12bb7b02d44c3c916d31cd"
  end
